  ...
  return (
    ...
    >
      <video
        ...
        playsInline
      />
      {/* Warm sepia wash + vignette, matching the logo palette */}
...
/** Logo medallion wrapped in slowly counter-rotating ornamental rings. */
function LogoMedallion() {
  return (
    <div className="relative mx-auto mb-5 h-32 w-32 sm:h-36 sm:w-36">
      {/* Outer dashed lace ring */}
      <svg
      ...
      >
        <circle
          ...
          strokeDasharray="1 4"
        />
        {/* Scalloped dots like the logo's outer mandala */}
...
/** Gold corner flourish for the ornate card frame. */
...
export default function Hero() {
  return (
    <header className="relative flex min-h-screen flex-col items-center justify-center px-4 pt-12 pb-24">
      ...
      {/* Main landing card — double gilded frame, like the logo's medallion */}
      <div className="relative z-10 w-full max-w-3xl rounded-[2.5rem] border-2 border-accent/50 bg-[#1a130a]/40 p-2 shadow-[0_0_80px_rgba(200,155,60,0.25)] backdrop-blur-[3px]">
        <div className="relative rounded-[2rem] border border-accent/30 p-6 text-center sm:p-10">
          ...
          <p className="mx-auto mt-6 max-w-xl text-lg leading-relaxed text-foreground/85">
            הרכב אינסטרומנטלי המבצע מוזיקה מקורית המשלבת רוק מתקדם, מוזיקת
            עולם והשפעות אלקטרוניות פסיכדליות.
          </p>
      ...
      >
        <span className="text-xs tracking-widest">גלו עוד</span>
        <svg
          width="20"
          height="20"
          viewBox="0 0 20 20"
